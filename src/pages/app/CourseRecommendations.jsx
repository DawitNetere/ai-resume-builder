...
const CourseRecommendations = () => {
  ...
  const { courseRecommendations, loading, getCourseRecommendations } =
  ...
  const onSubmit = async ({ industryBranch, description }) => {
    await getCourseRecommendations(industryBranch, description);
  };
      ...
      <Card className="min-h-full">
        <CardHeader className="flex flex-col items-start p-0">
          <ModuleHeader
            ...
            description="Discover courses that can help you improve your skills."
            icon={<GraduationCapIcon className="w-8 h-8 stroke-primary-500" />}
          />
          <Divider />
